...
const on_ready = () => {
    ...
    global.metrics.guilds.inc(global.bot.guilds.size);
};
...
module.exports = {
    ...
    _init(){
        ...
        this.bot.on('guildCreate', _ => global.metrics.guilds.inc());
        this.bot.on('guildDelete', _ => global.metrics.guilds.dec());
